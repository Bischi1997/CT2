...
#define TEXT_WAIT_MOVING_UP     "WAIT_MOVING_UP"
#define TEXT_WAIT_MOVING_DOWN     "WAIT_MOVING_DOWN"
			...
			case F0_CLOSED:
					...
					switch(event){
						...
						case EV_BUTTON_F1:
								...
								ah_show_state(TEXT_WAIT_MOVING_UP);
								state = WAIT_MOVING_UP;
							break;
						default:
								state = F0_CLOSED;
							break;					
			...
			case F1_CLOSED:
					...
					switch(event){
						...
						case EV_BUTTON_F0:
								ah_door(DOOR_LOCK);
								timer_start(SAFETY_DURATION);
								ah_show_state(TEXT_WAIT_MOVING_DOWN);
								state = WAIT_MOVING_DOWN;
							break;						
						default:
								state = F1_CLOSED;
							break;
